...
@pytest.mark.parametrize(
    "tensor_shape, shard_shape, num_cores",
    [
        ((2048, 42752), (2048, 3584), 12),
    ],
)
def test_from_torch_mesh_width_sharded_dram_tile_oom_45331(mesh_device, tensor_shape, shard_shape, num_cores):
    """
